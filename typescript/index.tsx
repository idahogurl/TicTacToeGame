  ...
  render() {
    return (
      <div id="prompt" className={this.props.className}>
        Do you want to be <br /><a className="xLetter" onClick={this.props.handleClick}>X</a> or <a className="oLetter" onClick={this.props.handleClick}>O</a>?
      </div>
    );
  }
}
...
@observer class TicTacToeGame extends Component<any, any> {
  ...
  selectLetter(e: MouseEvent) {
    ...
    let user: string = target.innerHTML;
  ...
  spaceSelected(e: MouseEvent) {
    const target = e.target as HTMLTableCellElement;
    let spaceSelection = parseInt(target.id);
  ...
  render() {
    ...
    if (this.game.computer.isWinner) {
